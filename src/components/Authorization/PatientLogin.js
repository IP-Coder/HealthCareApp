                                ...
                                <div className="col-md-12 mb-2">
                                    <div className="row">
                                        ...
                                        <div className="col-md-9">
                                            <input required onChange={onChange} placeholder="Registerd Mobile Number" type="tel" name="mobile" className="form-control " id="exampleInputPassword1" />
                                        </div>
                                    </div>
                                </div>
                                <div className="text-center formBtn">
                                    <button type="submit" className="btn btn-primary " disabled={loginData.mobile.length < 10} data-bs-toggle="modal" data-bs-target="#exampleModal" >Get Otp</button>
                                    <hr />
                                </div>
                            </form>
                        ...
                        <form onSubmit={getOtp}>
                            <div className="modal-body">
                                <div className=" col-md-12 my-2">
                                    ...
                                    <div id="messeg" className="form-text">We have send a otp on your registerd mobile number</div>
                                    <input placeholder=" Enter Otp Here" pattern="[0-9]*" step="any" required onChange={onChange} type="number" name="name" className="form-control " id="exampleInputtext"
                                        aria-describedby="emailHelp" />

                                </div>
                            </div>
                            <div className="modal-footer">
                                <button type="submit" className="btn btn-primary " data-bs-toggle="modal" data-bs-target="#exampleModal" >Verify Otp</button>
                            </div>
                        </form>
                    </div>
                </div>
