        ...
        <>
            <section className=" ">
                ...
                <div className="bg-white">
                    <h3 className="text-center mt-2"><u>Doctors Team List</u></h3>
                    ...
                    <div className="text-center mt-5 ">
                        <button type="submit" className="mb-3 btn btn-primary" data-bs-toggle="modal"
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="staticBackdropLabel">Add New Member</h5>
