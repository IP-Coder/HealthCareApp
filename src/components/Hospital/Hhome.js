            ...
            <section style={{ marginTop: "3rem" }} className="container">
                ...
                <div className="p-3 bg-white">
                    <form className="row" method="POST" action="addPatient.php">
                        ...
                        <div className="row">
                            <div className="col-md-5">
                                ...
                                <select required id="country" name="gender" className="form-control">
                                    ...
                                    <option data-countrycode="GB" value="Female">Female</option>
                                    <option data-countrycode="US" value="transgender">Not preferd to tell</option>
                                </select>
                            </div>
                        ...
                        <h3 className="text-center mt-2"><u>Full Body Screening</u></h3>
